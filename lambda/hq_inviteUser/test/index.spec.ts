...
import { describe, test, beforeEach, type TestContext, MockModuleContext, mock } from "node:test";
...
describe("hq_inviteUser tests", () => {
    ...
    beforeEach((c) => {
        ...
        ctx.mock.method(Mailer.prototype, "sendHTMLEmail", async (to: string, html: string, title: string) => ({
